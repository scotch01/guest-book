<x-app-layout>
    <div class="p-6 space-y-6 max-w-[1600px] mx-auto">
        ...
        {{-- TABLE CARD --}}
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-visible relative">
            <div class="relative">
                    ...
                    <table class="w-full text-sm border-collapse">
                        <thead class="bg-gray-50/80 text-gray-500 text-xs uppercase tracking-wider">
                            <tr class="border-b border-gray-200">
                                ...
                                <th class="px-6 py-4 text-left font-bold border-r border-gray-100">Layanan & Keperluan
                                </th>
                            ...
                            @forelse($guests as $i => $guest)
                                <tr class="hover:bg-indigo-50/30 transition-colors">
                                    ...
                                    <td class="px-6 py-4 border-r border-gray-100 text-center">
                                        <div class="text-xs font-bold text-gray-800">{{ $guest->tanggal_kunjungan }}
                                        </div>
                                    ...
                                    <td class="px-6 py-4 border-r border-gray-100">
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <div class="text-xs text-gray-600 line-clamp-1">{{ $guest->keperluan }}
                                            </div>
            ...
            'text' => $e->nama,
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="open" x-cloak @click.outside="open = false"
                                                            ...
                                                            class="fixed bg-white border rounded-xl shadow-lg z-[9999] max-h-64 overflow-y-auto">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="p-12 text-center text-gray-400 italic">Tidak ada data
                                        tamu
                                        ditemukan.</td>
                                </tr>
                            @endforelse
            ...
            return {
                ...
                toggle(event) {
                    ...
                    if (this.open) {
                        ...
                        // ⬆️ auto naik kalau mentok bawah
                        if (this.y + dropdownHeight > viewportHeight) {
                            this.y = rect.top - dropdownHeight - 6
                        }
                    }
                },
